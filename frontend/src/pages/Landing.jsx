...
const Landing = () => (
  <>
    <Navbar />
    <section style={{ padding: '88px 0 64px', textAlign: 'center' }}>
      <div className="container">
        <span style={{ display: 'inline-block', background: 'var(--color-primary-light)', color: 'var(--color-primary)', fontWeight: 600, fontSize: 13, padding: '6px 14px', borderRadius: 20, marginBottom: 20 }}>
          Loans made simple
        </span>
        <h1 className="display" style={{ fontSize: 52, fontWeight: 800, lineHeight: 1.1, maxWidth: 720, margin: '0 auto 20px' }}>
          Borrow with clarity, repay with confidence
        </h1>
        <p style={{ fontSize: 18, color: 'var(--color-text-muted)', maxWidth: 540, margin: '0 auto 32px' }}>
    ...
    <section style={{ padding: '48px 0', background: 'var(--color-surface)', borderTop: '1px solid var(--color-border)', borderBottom: '1px solid var(--color-border)' }}>
      <div className="container">
        <h2 style={{ textAlign: 'center', fontSize: 26, marginBottom: 8 }}>Loans for every need</h2>
        <p style={{ textAlign: 'center', color: 'var(--color-text-muted)', marginBottom: 36 }}>Competitive rates, calculated transparently</p>
