  ...
  return (
    <aside style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontWeight: 800, fontSize: 18, padding: '0 8px', marginBottom: 32 }} className="display">
        <span style={{ width: 30, height: 30, background: 'var(--color-primary)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: 15 }}>₹</span>
        LoanEase
      </div>
        ...
        {links.map((l) => (
          <NavLink
            ...
            style={({ isActive }) => ({
              ...
              fontSize: 14, fontWeight: 600, color: isActive ? 'var(--color-primary)' : 'var(--color-text-muted)',
